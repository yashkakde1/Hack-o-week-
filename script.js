...
class AdvancedSITNAGPURChatbot {
    constructor() {
        ...
        this.entityPatterns = {
            ...
            courses: [
                /b\.?\s*tech|btech|b\.tech|bachelor\s+of\s+technology/i,
                /m\.?\s*tech|mtech|m\.tech|master\s+of\s+technology/i,
                /mba|master\s+of\s+business\s+administration/i,
                /phd|doctor\s+of\s+philosophy/i,
                /computer\s+science|cse|cs/i,
                /mechanical|me/i,
                /electronics|ece|ec/i,
                /civil|ce/i,
                /data\s+science|ai|artificial\s+intelligence|ml|machine\s+learning/i,
                /robotics/i
            ],
            numbers: [
        ...
        // TF-IDF Vocabulary and Document Vectors (Topic 4)
    ...
    async processMessage(message) {
        ...
        // Topic 3: Synonym expansion
        processedMessage = this.expandSynonyms(processedMessage);
        
        // Topic 8: Check for handover first
        ...
        // Topic 7: Context-aware handling
        ...
        if (isFollowUp && this.conversationContext.lastTopic) {
            ...
            // Topic 4: TF-IDF retrieval (if intent not confident)
            if (intent === 'general') {
        ...
        this.conversationContext.followUpCount = isFollowUp ? this.conversationContext.followUpCount + 1 : 0;
        ...
        // Topic 9: Add channel information
        const channelInfo = this.getChannelResponse('web');
        response += `\n\n---\n${channelInfo}`;
